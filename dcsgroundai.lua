...
function newHIGHCOMMAND (PREFIX)
	...
	local assignForceStructure = function (commanderConfig)
...
-- 3b.  Force Structure
-- *********************************************************
highCommand.assignForceStructure(_COMMANDER_CONFIG)
